/**
 * @file Seasons Page Tab Item - Form - EditSyllabusPopup
 *
...
const Index = (props: Props) => {
  const { SeasonAPI, FormAPI } = useAPIv2();
    ...
    >
      <div style={{ marginBottom: "24px" }}>
        <Callout
          ...
          title="주의사항"
          showIcon
          description="학기에 양식을 등록한 후 원본 양식이 수정되는 경우 학기 양식에는 반영되지 않습니다. 강의계획서 데이터가 입력되기 전에는 양식을 다시 선택할 수 있습니다."
        />
      </div>
