...
import style from "../../style/pages/classes/classes.module.scss";
type Props = {};
    ...
    return (
      <div className={`${style.tab_item} ${style.teachers_container}`}>
        <div className={style.teachers}>
          {classData.teachers.map((value, index) => {
            return (
              <>
    ...
    <div className={style.section}>
      ...
      <div className={style.categories_container}>
        <div className={style.categories}>
          ...
          <div className={style.category}>과목: {classData.subject[1]}</div>
          <div className={style.category}>학점: {classData.point}</div>
