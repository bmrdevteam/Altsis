...
export const AI_NOT_ENABLED_FOR_SEASON = "AI_NOT_ENABLED_FOR_SEASON";
export const AI_API_KEY_NOT_SET = "AI_API_KEY_NOT_SET";
...
export const AI_INVALID_API_KEY = "AI_INVALID_API_KEY";
export const AI_GENERATION_FAILED = "AI_GENERATION_FAILED";
export const AI_CONTENT_BLOCKED = "AI_CONTENT_BLOCKED";
