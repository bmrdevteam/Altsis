...
/**
 * @description Upload course cover image as "{bucket}/original/{academyId}/courses/{syllabusId}/{filename}"
 * AWS Lambda will copy this as "{bucket}/thumb/{academyId}/courses/{syllabusId}/{filename}"
 */
export const courseMulter = multer({
  ...
  storage: multerS3({
    ...
    key: function (req, file, cb) {
      ...
      cb(
        null,
        `original/${req.user.academyId}/courses/${req.params._id}/${filename}`
      );
    },
  }),
